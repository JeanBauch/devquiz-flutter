...
class QuizWidget extends StatefulWidget {
  ...
  final ValueChanged<bool> onSelectd;
  const QuizWidget({ Key? key, required this.question, required this.onSelectd }) : super(key: key);
          ...
          for(var i = 0; i < widget.question.awnsers.length; i++) 
            AwnserWidget(
              ...
              onTap: (value) {
                indexSelected = i;
                setState(() { });
                Future.delayed(Duration(milliseconds: 800)).then((_) => widget.onSelectd(value));
              },
            ),
